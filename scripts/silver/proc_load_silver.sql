...
BEGIN
	...
	BEGIN TRY
		...
		WHERE flag_last=1; -- Select the most recent record as per created date
		...
		*/
		...
		PRINT '>> Truncxating table: silver.erp_loc_a101'
		...
		CASE 
			...
			ELSE TRIM(cntry)
		END AS cntry -- Normalize and Handle missing or blank values
